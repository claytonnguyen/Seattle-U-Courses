...
// Class Invariant: Class is composed of a buy function along with the
// public attributes of the base customer class. When buying one entree,
// a name is needed to be supplied to the function.
//
//
...
// through inheritence. Customer does not have access to a buy random function
// like in a diabetic or low carb customer since an allergic person should be
// more careful and only buy one item at a time and supplying the name of the
// entree they want to buy
